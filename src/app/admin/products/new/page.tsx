...
import { saveGiftSets, type GiftSetDraft, type GiftSetItemDraft } from '@/services/giftSets';
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex gap-4">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="radio"
                          checked={giftSet.giftMode === 'auto'}
                          onChange={() => updateGiftSet(giftSet.localId, { giftMode: 'auto' })}
                        />
                        <div>
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="radio"
                          checked={giftSet.giftMode === 'select'}
                          onChange={() => updateGiftSet(giftSet.localId, { giftMode: 'select' })}
                        />
                        <div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <Input
                            ...
                            onChange={(e) => updateGiftSet(giftSet.localId, {
                              maxDistinctItems: e.target.value ? Number(e.target.value) : null,
                            })}
                            className="w-24"
                            placeholder="제한 없음"
                          />
                          ...
                          {giftSet.giftMode === 'select' && (
                            <div className="flex items-center gap-1 flex-shrink-0">
                              ...
                              <Input
                                ...
                                onChange={(e) => updateGiftItem(giftSet.localId, item.localId, {
                                  maxPerItem: e.target.value ? Number(e.target.value) : null,
                                })}
